...
class APManager:
    """
    Gets AP info when smartshield is running as an AP in the RPI
    https://stratospherelinuxips.readthedocs.io/en/develop/immune/installing_smartshield_in_the_rpi.html#protect-your-local-network-with-smartshield-on-the-rpi
    """
    ...
    def store_ap_interfaces(self, input_information):
        """
        stores the interfaces given with -ap to smartshield in the db
        """
