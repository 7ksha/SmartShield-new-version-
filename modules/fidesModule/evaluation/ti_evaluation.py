...
class TIEvaluation:
    def evaluate(self,
                 aggregated_ti: smartshieldThreatIntelligence,
...
class LocalCompareTIEvaluation(DistanceBasedTIEvaluation):
    ...
    def get_local_ti(self,
                     target: Target,
                     local_ti: Optional[smartshieldThreatIntelligence] = None) -> Optional[smartshieldThreatIntelligence]:
        if local_ti:
            return local_ti
    ...
    def evaluate(self,
                 ...
                 responses: Dict[PeerId, PeerIntelligenceResponse],
                 trust_matrix: TrustMatrix,
                 local_ti: Optional[smartshieldThreatIntelligence] = None,
                 **kwargs,
                 ) -> Dict[PeerId, Tuple[PeerTrustData, Satisfaction, Weight]]:
        super()._assert_keys(responses, trust_matrix)
