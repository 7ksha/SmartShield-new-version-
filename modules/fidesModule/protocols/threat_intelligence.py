...
from ..model.threat_intelligence import ThreatIntelligence, smartshieldThreatIntelligence
from ..persistence.threat_intelligence_db import smartshieldThreatIntelligenceDatabase
from ..persistence.trust_db import smartshieldTrustDatabase
...
class ThreatIntelligenceProtocol(Protocol):
    ...
    def __init__(self,
                 ...
                 network_opinion_callback: Callable[[smartshieldThreatIntelligence], None]
                 ):
    ...
    def __filter_ti(self,
                    ti: Optional[smartshieldThreatIntelligence],
                    peer_trust: PeerTrustData) -> Optional[smartshieldThreatIntelligence]:
        if ti is None:
            return None
