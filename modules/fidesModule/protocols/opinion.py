...
from ..persistence.threat_intelligence_db import smartshieldThreatIntelligenceDatabase
...
class OpinionAggregator:
    ...
    def evaluate_alert(self, peer_trust: PeerTrustData, alert: Alert) -> smartshieldThreatIntelligence:
        """Evaluates given data about alert and produces aggregated intelligence for smartshield."""
        ...
        return smartshieldThreatIntelligence(score=score, confidence=confidence, target=alert.target)

    def evaluate_intelligence_response(self,
                                       target: Target,
                                       data: Dict[PeerId, PeerIntelligenceResponse],
                                       trust_matrix: TrustMatrix) -> smartshieldThreatIntelligence:
        ...
        return smartshieldThreatIntelligence(score=ti.score, confidence=ti.confidence, target=target)
