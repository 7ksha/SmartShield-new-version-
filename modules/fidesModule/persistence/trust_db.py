...
class smartshieldTrustDatabase(TrustDatabase):
    """Trust database implementation that uses smartshield redis and own SQLite as
    a storage."""
    ...
    def store_connected_peers_list(self, current_peers: List[PeerInfo]):
        """Stores list of peers that are directly connected to the smartshield."""
    ...
    def get_connected_peers(self) -> List[PeerInfo]:
        """Returns list of peers that are directly connected to the smartshield."""
    ...
    def cache_network_opinion(self, ti: smartshieldThreatIntelligence):
    ...
    def get_cached_network_opinion(
        ...
        if rec is None:
            ...
            return smartshieldThreatIntelligence.from_dict(rec)
