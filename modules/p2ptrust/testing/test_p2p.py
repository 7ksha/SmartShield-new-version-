...
# TODO
# base_dir = "/home/dita/ownCloud/stratosphere/smartshield/modules/p2ptrust/testing/"
...
def test_smartshield_integration():
    ...
    # smartshield makes some detections
    print("smartshield makes a detection of IP 1.2.3.4")
    set_ip_data("1.2.3.4", {"score": 0.3, "confidence": 1})
    time.sleep(0.5)
    print()

    print("smartshield makes a detection of IP 1.2.3.6")
    ...
    print("smartshield asks about data for 1.2.3.5")
    # smartshield asks for data about 1.2.3.5
    data_to_send = {
        "ip": "tst",
...
def test_ip_info_changed():
    ...
    print(
        "smartshield makes 5 repeating detections, but module is stupid and shares them all"
    )
...
def test_ip_data_save_to_redis():
    print("Data in smartshield for ip 1.2.3.4")
...
def get_default_config():
    ...
    cfg.read_file(open("smartshield.yaml"))
    return cfg


def make_data():
    # the data is a list of reports from multiple peers. Each report contains information about the remote peer (his IP
    # and his credibility), and the data the peer sent. From smartshield, we know that the data sent contains the IP address
...
def smartshield_listener_test():
    ...
    :return: None
    """
    print("Running smartshield listener test")
...
def test_handle_smartshield_update():
    print("smartshield asks about data for 1.2.3.5")
    # smartshield asks for data about 1.2.3.5 and cache age 1000
    data_to_send = {
        "ip": "tst",
        "profileid": "profileid_192.168.1.1",
        "twid": "timewindow1",
...
if __name__ == "__main__":
    ...
    # test_inputs()
    # test_smartshield_integration()
    # test_ip_data_save_to_redis()
    # test_handle_smartshield_update()
    # test_pigeon()
