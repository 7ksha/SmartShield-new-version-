...
The complete set of scripts used for finetuning the used inside smartshield Immune are avaiable 
[here](https://github.com/stratosphereips/smartshield-tools/tree/main/unsloth-scripts)
