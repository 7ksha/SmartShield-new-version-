...
smartshield comes with some datasets for you to try on the folder `dataset`. They are a mix of real malware, real normal, both malicious and bening, in Argus format, Zeek, pcap, etc. 
