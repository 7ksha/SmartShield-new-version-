...
def test_clear_redis_cache():
    ...
    checker.main.terminate_smartshield.assert_called_once()
...
def test_check_given_flags_root_user(monkeypatch):
    ...
    with mock.patch.object(
        ...
        checker.main, "terminate_smartshield"
    ) as mock_term:
        checker.verify_given_flags()
