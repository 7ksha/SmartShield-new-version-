...
@pytest.mark.parametrize(
    "smartshield_internal_time, modified_profiles,"
    "last_modified_tw_time, expected_modified_ips, "
    "expected_set_smartshield_internal_time_call_args",
    [
...
def test_update_smartshield_stats_in_the_db(
    smartshield_internal_time,
    modified_profiles,
    ...
    metadata_manager = ModuleFactory().create_metadata_manager_obj()
    metadata_manager.main.db.getsmartshieldInternalTime.return_value = str(
        smartshield_internal_time
    )
    ...
    modified_ips, returned_modified_profiles = (
        metadata_manager.update_smartshield_stats_in_the_db()
    )
    ...
    assert (
        metadata_manager.main.db.set_smartshield_internal_time.call_args_list
        == expected_set_smartshield_internal_time_call_args
    )
