...
def test_horizontal(path, output_dir, redis_port):
    """
    checks that smartshield is detecting horizontal ps no issue,
    """
    ...
    # make sure smartshield generated profiles for this file (can't
    # put the number of profiles exactly because smartshield
