...
def test_store_smartshield_threat_intelligence(db):
    # Create a smartshieldThreatIntelligence object
    intelligence = smartshieldThreatIntelligence(
        target="example.com", score=-1, confidence=0.9, confidentiality=0.75
    )

    # Store the intelligence in the database
    db.store_smartshield_threat_intelligence(intelligence)

    # Fetch it back using the target
    result = db.get_smartshield_threat_intelligence_by_target("example.com")
...
def test_get_smartshield_threat_intelligence_by_target(db):
    # Create a smartshieldThreatIntelligence object and insert it
    intelligence = smartshieldThreatIntelligence(
        target="192.168.1.1",
        score=0.70,
        confidence=1.0,
    ...
    result = db.get_smartshield_threat_intelligence_by_target("192.168.1.1")
