...
#     command = f'sudo ./smartshield.py -l -f dataset/test9-mixed-zeek-dir -s > /dev/null 2>&1'
...
#
#     # this test needs sudo
#     command = f'sudo ./smartshield.py -d redis_backups/test9-mixed-zeek-dir.rdb  > /dev/null 2>&1'
#     # this function returns when smartshield is done
#     os.system(command)
