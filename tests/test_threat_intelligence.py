...
import ipaddress
from smartshield_files.core.structures.evidence import ThreatLevel
...
def test_check_local_ti_files_for_update(
    ...
    mock_hash = mocker.patch(
        "smartshield_files.common.smartshield_utils.Utils.get_sha256_hash_of_file_contents"
    )
...
def test_read_configuration(mocker):
    ...
    with patch(
        ...
        MockConfigParser.return_value.local_ti_data_path.return_value = (
            "/tmp/smartshield/local_ti_files"
        )
        ...
        os.mkdir.assert_called_once_with("/tmp/smartshield/local_ti_files")
