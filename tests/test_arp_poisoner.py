...
def test_can_poison_ip(
    ...
    with patch(
        "smartshield_files.common.smartshield_utils.utils.is_public_ip",
...
def test__attack_uses_cache(poisoner):
    with (
        patch(
            "smartshield_files.common.smartshield_utils.utils"
...
def test__attack_fallback_to_arp(poisoner):
    with patch(
        "smartshield_files.common.smartshield_utils.utils.get_mac_for_ip_using_cache",
        return_value=None,
    ):
        with patch.object(
