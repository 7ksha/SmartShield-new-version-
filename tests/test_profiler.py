...
"""Unit test for smartshield_files/core/iperformance_profiler.py"""
...
import pytest
import json
from smartshield_files.core.profiler import SUPPORTED_INPUT_TYPES, SEPARATORS
...
def test_define_separator_zeek_dict(
    ...
    """
    :param input_type: as determined by smartshield.py
    """
...
# pcaps are treated as zeek files in smartshield, no need to test twice
...
def test_get_private_client_ips(client_ips, expected_private_ips, monkeypatch):
    ...
    with patch(
        "smartshield_files.core.profiler.utils.is_private_ip"
...
def test_convert_starttime_to_epoch():
    ...
    with patch(
        "smartshield_files.core.profiler.utils.convert_ts_format"
...
@patch("smartshield_files.core.profiler.ConfigParser")
...
@patch("smartshield_files.core.helpers.flow_handler")
...
def test_get_local_net(client_ips, saddr, expected_cidr):
    ...
    if not client_ips:
        with patch.object(
            ...
            "smartshield_files.common.smartshield_utils.Utils.get_cidr_of_private_ip",
...
@patch("smartshield_files.core.profiler.utils.is_private_ip")
@patch("smartshield_files.core.profiler.utils.is_ignored_ip")
