...
def test_get_analysis_time(
    ...
    process_manager.main.db.get_smartshield_start_time.return_value = start_time_str
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (None, True, False),
        # Test case 2: Message doesn't contain "stop_smartshield"
        ({"data": "some_other_message"}, True, False),
        # Test case 3: Message contains
        # "stop_smartshield" but not intended for control channel
        ({"data": "stop_smartshield"}, False, False),
        # Test case 4: Message contains
        # "stop_smartshield" and intended for control channel
        ({"data": "stop_smartshield"}, True, True),
    ],
)
def test_is_stop_msg_received(
    ...
    with patch(
        "smartshield_files.common.smartshield_utils.utils.is_msg_intended_for"
