...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "3 over 1 flows. Confidence: 0.3. by smartshield",
            Victim(
                value="192.168.1.1",
        ...
        (
            ...
            "Total packets sent: 100 over 5 flows. Confidence: 1. by smartshield",
            None,
        ),
        ...
        (
            ...
            "Total packets sent: 25 over 3 flows. Confidence: 1. by smartshield",
            Victim(
                value="172.16.0.1",
                direction=Direction.DST,
                ioc_type=IoCType.IP,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "different IP addresses. Confidence: 0.8. by smartshield",
        ),
        # Testcase 2: Multiple DHCP requests
        (
            "2023-04-01 13:00:00",
