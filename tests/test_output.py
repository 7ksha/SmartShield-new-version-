...
@patch("smartshield_files.core.output.Output.print")
@patch("smartshield_files.core.output.Output.log_line")
@patch("smartshield_files.core.output.Output.log_error")
