...
def test_should_ignore_conn_without_dns(
    ...
    mocker.patch(
        "smartshield_files.common.smartshield_utils.utils.is_ignored_ip",
...
def test_is_well_known_org(
    ...
    mock_is_ip_asn_in_org_asn = mocker.patch(
        "smartshield_files.core.helpers.whitelist.organization_whitelist."
    ...
    mock_is_ip_in_org = mocker.patch(
        "smartshield_files.core.helpers.whitelist."
