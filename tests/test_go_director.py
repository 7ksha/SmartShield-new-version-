...
def test_read_configuration():
    with patch(
        "smartshield_files.common.parsers.config_parser.ConfigParser",
        return_value=3600.0,
    ):
        go_director = ModuleFactory().create_go_director_obj()
...
def test_process_message_request_valid_request():
    ...
    go_director.print.assert_called_once_with(
        "[The Network -> smartshield] request about "
...
def test_respond_to_message_request_with_info():
    ...
    with patch(
        "modules.p2ptrust.utils." "go_director.get_ip_info_from_smartshield",
        ...
        with patch(
            ...
            expected_print = (
                f"[smartshield -> The Network] smartshield responded "
...
def test_respond_to_message_request_without_info():
    ...
    with patch(
        ...
        with patch(
            ...
            expected_print = (
                f"[smartshield -> The Network] smartshield has no info about IP: {key}. "
